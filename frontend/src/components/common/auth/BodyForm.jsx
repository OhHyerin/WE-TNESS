...
import { fetchWeight, fetchHeight } from '../../../features/user/EditSlice';

export default function BodyForm() {
  const dispatch = useDispatch();
  const weight = useSelector(state => state.edit.userInfo.weight);
  const height = useSelector(state => state.edit.userInfo.height);
